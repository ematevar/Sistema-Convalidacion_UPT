namespace TG01U2_Convalidacion_Atencio_Neciosup_A
{
    partial class SistemaConvalidacion
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbSemestre = new ComboBox();   // ← ComboBox en lugar de TextBox
            lblAnio = new Label();
            txtAnio = new TextBox();
            lblPais = new Label();
            ...
            cmbSemestre.Location = new Point(160, 141);
            cmbSemestre.Name = "cmbSemestre";
            cmbSemestre.Size = new Size(100, 28);
            cmbSemestre.TabIndex = 5;
        ...
        private ComboBox cmbSemestre;       // ← ComboBox
